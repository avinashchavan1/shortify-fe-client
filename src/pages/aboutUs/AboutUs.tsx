                    ...
                    <Row gutter={[48, 48]} align="middle">
                        ...
                        <Col xs={24} md={12}>
                            <div className="mission-content">
                                <Title level={2} className="gradient-text">Our Mission</Title>
                                <Paragraph className="mission-text">
                                    At Shortify, we believe in making the internet more accessible and manageable.
                                    Our mission is to simplify link sharing while providing powerful analytics and
                                    tools that help individuals and businesses optimize their online presence.
                                </Paragraph>
                                <Paragraph className="mission-text">
                                    We started in 2018 with a simple idea: what if sharing links could be easier
                                    and more insightful? Today, we've helped millions of users share billions of
                                    links, and we're just getting started.
                                </Paragraph>
                            </div>
                        </Col>
                    </Row>
                    ...
                    <Row gutter={[32, 32]}>
                        ...
                        <Col xs={24} sm={12} lg={8}>
                            <Card className="value-card">
                                ...
                                <Paragraph>
                                    We believe in making the web more accessible for everyone, regardless of technical expertise.
                                </Paragraph>
                            </Card>
                        </Col>
                    </Row>
