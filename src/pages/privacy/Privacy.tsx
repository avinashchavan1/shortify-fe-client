...
export const Privacy = () => {
  const styles = {
    ...
    h1: { fontSize: '2rem', marginBottom: '10px', color: '#1890ff' },
    h2: { fontSize: '1.5rem', marginTop: '30px', marginBottom: '15px', color: '#1890ff' },
    h3: { fontSize: '1rem', marginTop: '20px', marginBottom: '10px', color: '#1890ff' },
    h4: { fontSize: '0.8rem', marginTop: '15px', marginBottom: '10px', color: '#1890ff' },
    p: { lineHeight: '1.6', marginBottom: '15px' },
    a: { color: '#0066cc', textDecoration: 'underline' },
    ul: { paddingLeft: '20px', marginBottom: '20px' },
  ...
  return (
    <LayoutHoc>
      <div style={styles.container}>
        ...
        <p style={styles.p}>Last updated: July 26, 2025</p>
        <p style={styles.p}>
        ...
        <ul style={styles.ul}>
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>Account</span> means a unique account created for You to
              access our Service or parts of our Service.
            </p>
          </li>
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>Affiliate</span> means an entity that controls, is
          ...
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>Company</span> (referred to as either &quot;the
          ...
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>Cookies</span> are small files that are placed on Your
          ...
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>Country</span> refers to: Karnataka, India
            </p>
          </li>
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>Device</span> means any device that can access the Service
              such as a computer, a cellphone or a digital tablet.
            </p>
          </li>
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>Personal Data</span> is any information that relates to an
              identified or identifiable individual.
            </p>
          </li>
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>Service</span> refers to the Website.
            </p>
          </li>
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>Service Provider</span> means any natural or legal person
          ...
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>Usage Data</span> refers to data collected automatically,
          ...
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>Website</span> refers to Avibit, accessible from{' '}
              <a
                href="https://www.avibit.com"
          ...
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>You</span> means the individual accessing or using the
        ...
        <h4 style={styles.h4}>Usage Data</h4>
        <p style={styles.p}>Usage Data is collected automatically when using the Service.</p>
        <p style={styles.p}>
        ...
        <h4 style={styles.h4}>Tracking Technologies and Cookies</h4>
        <p style={styles.p}>
        ...
        <ul style={styles.ul}>
          <li style={styles.li}>
            <span style={styles.bold}>Cookies or Browser Cookies.</span> A cookie is a small file
          ...
          <li style={styles.li}>
            <span style={styles.bold}>Web Beacons.</span> Certain sections of our Service and our
        ...
        <ul style={styles.ul}>
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>Necessary / Essential Cookies</span>
            </p>
          ...
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>Cookies Policy / Notice Acceptance Cookies</span>
            </p>
          ...
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>Functionality Cookies</span>
            </p>
            <p>Type: Persistent Cookies</p>
            <p>Administered by: Us</p>
            <p>
        ...
        <h3 style={styles.h3}>Use of Your Personal Data</h3>
        <p style={styles.p}>The Company may use Personal Data for the following purposes:</p>
        <ul style={styles.ul}>
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>To provide and maintain our Service</span>, including to
              monitor the usage of our Service.
            </p>
          </li>
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>To manage Your Account:</span> to manage Your registration
              as a user of the Service. The Personal Data You provide can give You access to
          ...
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>For the performance of a contract:</span> the development,
          ...
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>To contact You:</span> To contact You by email, telephone
          ...
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>To provide You</span> with news, special offers and general
          ...
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>To manage Your requests:</span> To attend and manage Your
              requests to Us.
            </p>
          </li>
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>For business transfers:</span> We may use Your information
          ...
          <li style={styles.li}>
            <p>
              <span style={styles.bold}>For other purposes</span>: We may use Your information for
        ...
        <p style={styles.p}>We may share Your personal information in the following situations:</p>
        <ul style={styles.ul}>
          <li style={styles.li}>
            <span style={styles.bold}>With Service Providers:</span> We may share Your personal
            information with Service Providers to monitor and analyze the use of our Service, to
            contact You.
          </li>
          <li style={styles.li}>
            <span style={styles.bold}>For business transfers:</span> We may share or transfer Your
          ...
          <li style={styles.li}>
            <span style={styles.bold}>With Affiliates:</span> We may share Your information with Our
          ...
          <li style={styles.li}>
            <span style={styles.bold}>With business partners:</span> We may share Your information
            with Our business partners to offer You certain products, services or promotions.
          </li>
          <li style={styles.li}>
            <span style={styles.bold}>With other users:</span> when You share personal information
            or otherwise interact in the public areas with other users, such information may be
            viewed by all users and may be publicly distributed outside.
          </li>
          <li style={styles.li}>
            <span style={styles.bold}>With Your consent</span>: We may disclose Your personal
            information for any other purpose with Your consent.
          </li>
        </ul>

        <h3 style={styles.h3}>Retention of Your Personal Data</h3>
        <p style={styles.p}>
        ...
        <h3 style={styles.h3}>Transfer of Your Personal Data</h3>
        <p style={styles.p}>
        ...
        <h3 style={styles.h3}>Delete Your Personal Data</h3>
        <p style={styles.p}>
        ...
        <h3 style={styles.h3}>Disclosure of Your Personal Data</h3>
        <h4 style={styles.h4}>Business Transactions</h4>
        <p style={styles.p}>
        ...
        <h4 style={styles.h4}>Law enforcement</h4>
        <p style={styles.p}>
        ...
        <h4 style={styles.h4}>Other legal requirements</h4>
        <p style={styles.p}>
          The Company may disclose Your Personal Data in the good faith belief that such action is
          necessary to:
        </p>
        <ul style={styles.ul}>
          <li style={styles.li}>Comply with a legal obligation</li>
          <li style={styles.li}>Protect and defend the rights or property of the Company</li>
          <li style={styles.li}>
          ...
          <li style={styles.li}>Protect against legal liability</li>
        </ul>

        <h3 style={styles.h3}>Security of Your Personal Data</h3>
        <p style={styles.p}>
        ...
        <ul style={styles.ul}>
          <li style={styles.li}>
            By email:{' '}
            <a href="mailto:avinash@gmail.com" style={styles.a}>
              avinash@gmail.com
            </a>
          </li>
        </ul>
